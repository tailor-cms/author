...
test('as a Default user, I should be able to create Repository', async ({
  page,
}) => {
  await page.goto('/');
...
test('as a Default user, I should not see the admin menu entry', async ({ page }) => {
  await page.goto('/');
  const appBar = new AppBar(page);
  await expect(appBar.adminLink).not.toBeVisible();
});

test('as a Default user, I should not be able to access User Management', async ({
  page,
}) => {
...
test('as a Default user, I should not be able to access Group management', async ({
  page,
}) => {
...
test('as a Default user, I should not be able to access Structure Types', async ({
  page,
}) => {
...
test('as a Default user, I should not be able to access Installed Elements', async ({
  page,
}) => {

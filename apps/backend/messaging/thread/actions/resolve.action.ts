...
export default defineAction({
  ...
  openapi: {
    ...
    description: oneLine`
      Marks the thread resolved, or reopens it. A resolved thread stays
      in the list unless it is filtered to open threads only. Anyone
      with access to the repository can do either.
    `,
    responses: {
      200: {

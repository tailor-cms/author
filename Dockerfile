...
ARG NUXT_PUBLIC_OIDC_ENABLED
ARG NUXT_PUBLIC_OIDC_LOGIN_TEXT
ARG NUXT_PUBLIC_OIDC_LOGOUT_ENABLED
...
ENV NUXT_PUBLIC_OIDC_ENABLED=${NUXT_PUBLIC_OIDC_ENABLED}
ENV NUXT_PUBLIC_OIDC_LOGIN_TEXT=${NUXT_PUBLIC_OIDC_LOGIN_TEXT}
ENV NUXT_PUBLIC_OIDC_LOGOUT_ENABLED=${NUXT_PUBLIC_OIDC_LOGOUT_ENABLED}
